...
@Slf4j
@MapperScan(
        basePackages = {"com.github.zuihou.uzi", "com.github.zuihou"}, annotationClass = Repository.class,
        sqlSessionFactoryRef = PetDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${zuihou.database.multiTenantType}')")
public class PetDatabaseAutoConfiguration extends MasterDatabaseConfiguration {

    public PetDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 zuihou.database.multiTenantType!=DATASOURCE，加载了 PetDatabaseAutoConfiguration");
    }
